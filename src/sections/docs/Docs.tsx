...
const sidebarItems = [
  ...
  { id: 'portable', label: 'Portable Architecture', icon: Layers },
  { id: 'principles', label: 'Principles-Based UX', icon: Lightbulb },
  { id: 'agent', label: 'Agent Thinking', icon: Code },
  { id: 'infrastructure', label: 'Infrastructure Mindset', icon: Globe },
];
    ...
    switch (activeSection) {
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: 'Portable Architecture', desc: 'Understand the system design', icon: Layers, section: 'portable' },
                { title: 'Principles-Based UX', desc: 'Learn our UX philosophy', icon: Lightbulb, section: 'principles' },
                { title: 'Agent Thinking', desc: 'Automation & intelligence', icon: Code, section: 'agent' },
                { title: 'Infrastructure Mindset', desc: 'Public APIs & Widgets', icon: Globe, section: 'infrastructure' },
              ].map((item) => {
      ...
      case 'portable':
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">Portable Architecture</h1>
              <p className="text-gray-400 text-lg">
      ...
      case 'principles':
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">Principles-Based UX</h1>
              <p className="text-gray-400 text-lg">
      ...
      case 'agent':
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">Agent Thinking</h1>
              <p className="text-gray-400 text-lg">
                The application implements agentic automation that maintains and improves the system over time.
                Instead of simple CRUD operations, the system proactively organizes and synthesizes knowledge.
              </p>
            </div>

            <GlassCard className="p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Automated Synthesizer</h3>
              <p className="text-gray-400 mb-4">
                Whenever a new note or article is saved, the internal AI agent acts autonomously to summarize
                lengthy content into digestible insights and automatically assigns relevant taxonomy tags (Auto-tagging).
              </p>
            </GlassCard>

            <GlassCard className="p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Conversational Retrieval (RAG)</h3>
              <p className="text-gray-400 mb-4">
                The agent parses user questions, filters the knowledge base semantically via vector similarity,
                and constructs a precise answer derived safely from your personal dataset.
              </p>
            </GlassCard>
          </div>
        );
      ...
      case 'infrastructure':
        return (
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">Infrastructure Mindset</h1>
              <p className="text-gray-400 text-lg">
                We believe your second brain shouldn't be locked into a single app.
                We expose functionality via flexible APIs and embeddable widgets.
              </p>
            </div>
            ...
            <GlassCard className="p-6">
              <h3 className="text-lg font-semibold text-white mb-4">Embeddable Widget</h3>
              <p className="text-gray-400 mb-4">
